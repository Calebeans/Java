...
public class FormCliente extends javax.swing.JDialog {
    ...
    public boolean validaCampos() {
        ...
        if (!(txtTelefone.getText().length() > 0)) {
            JOptionPane.showMessageDialog(null, "Informe seu telefone");
    ...
    private void initComponents() {
        ...
        cbCidade.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "São João Evangelista", "Guanhães", "Coluna", "Jacuri", "Nelson de Sena" }));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblObjetos, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.cidade}"), cbCidade, org.jdesktop.beansbinding.BeanProperty.create("selectedItem"));
        bindingGroup.addBinding(binding);
